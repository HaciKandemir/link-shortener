 ...
 */
final class Version20210313161343 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', DROP name, DROP surname, DROP role_id, DROP email_activation_code, DROP is_email_activated, DROP reset_password_code, DROP is_active, DROP created_at, DROP updated_at, DROP deleted_at, DROP is_deleted, CHANGE email email VARCHAR(180) NOT NULL, CHANGE password password VARCHAR(255) NOT NULL');
